    ...
    <section className="relative pb-32 bg-gray-800">
      <div className="absolute inset-0">
        <img
          ...
          src={`${BASE}/assets/kittyguardians_banner.png`}
          alt=""
        />
        <div
      ...
      <div className="relative px-4 py-24 mx-auto max-w-7xl sm:py-32 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
            ...
            <span className="block text-orange-400">KittyGuardians</span>
          </h1>
          <div className="max-w-md mx-auto text-gray-300 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            <p className="mt-6">
              NaeNaeKittyGuardians advances the decentralized Ethereum Web3 ecosystem by
